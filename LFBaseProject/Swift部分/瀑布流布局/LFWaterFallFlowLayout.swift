...
import UIKit
protocol LFWaterFallFlowLayoutDelegate: NSObjectProtocol {
    func waterFlowLayout(_ waterFlowLayout: LFWaterFallFlowLayout, itemHeight indexPath: IndexPath) -> CGFloat
}

class LFWaterFallFlowLayout: UICollectionViewFlowLayout {

    weak var delegate: LFWaterFallFlowLayoutDelegate?
    // 列数
    var cols = 2
    // 布局数组
...
extension LFWaterFallFlowLayout {
